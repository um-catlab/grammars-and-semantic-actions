{- THE FIELD, THROUGH THE JOINT LEMMA. `NoPoint.noFieldPoint` refutes every
   total point via the SLOTWISE `Domain.no-point`. -}
...
-- Brings in the JOINT reading, at `fldFib`: `Tuple o` DENOTES an argument
-- tuple for o `Composableᴳ o m⃗` DENOTES "this result is the o-composite
-- of m⃗" `Composable o m⃗` DENOTES "m⃗ composes SOMEWHERE" -- the domain
-- of definition proper, a predicate on TUPLES
