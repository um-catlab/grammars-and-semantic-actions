...
-- `ITr Ind u v w` DENOTES "w is a product of u and v in the trace monoid"
-- -- concretely, a two-colouring of w's positions reading off u and v in
-- order, every out-of-order pair of which is independent.
