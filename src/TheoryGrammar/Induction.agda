{- The DEPENDENT eliminator of `μ`. `Inductive.agda` exports `fold`, whose
   motive is `Ix → Type` -- enough to compute WITH a derivation, not enough
   to prove anything ABOUT one. -}
